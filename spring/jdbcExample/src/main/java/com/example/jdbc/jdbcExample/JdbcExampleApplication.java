...
public class JdbcExampleApplication {
	...
	*
	* @Repository: 데이터 계층 컴포넌트, 특징, 데이터베이스안의 연산에서 발생할 수 있는 예외를
	...
	* 이 어노테이션을 사용한 클래스는 클라이언트의 요청을 받아 처리하고 응답을 반환
	* (@RestController와 유사하지만 Restful 웹 서비스에서 사용)
	*
	*===============================================================================
	*
	* @Autowired
	...
	* 	- 불변성(=객체의 상태가 생성된 후 변경 되지 않음)을 보장, 필요한 의존성이 명확하게 표시
	*
